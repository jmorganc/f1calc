...
# Read
#drivers = json.loads(open('drivers.json', 'r').read())
# Initialize the drivers.json file
drivers_json = {}
for driver in drivers:
    drivers_json[driver] = {}
    for gp in calendar:
        drivers_json[driver][gp] = 0
#print json.dumps(drivers_json, indent=4, sort_keys=True)
# Write to file
open('drivers.json', 'w').write(json.dumps(drivers_json, indent=4, sort_keys=True))

# Initialize the grandsprix.json file
grandsprix_json = {}
for gp in calendar:
    grandsprix_json[gp] = {}
    for driver in drivers:
        grandsprix_json[gp][driver] = 0
#print json.dumps(grandsprix_json, indent=4, sort_keys=True)
# Write to file
